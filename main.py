...
def get_font(size):
    try: return pygame.font.Font("fast-money-four.ttf", size)
    except: return pygame.font.SysFont("Fast Money Four", size, bold=True)

font_score = get_font(55)
font_main = get_font(28)
font_x = get_font(100)
font_admin = pygame.font.SysFont("Fast Money Four", 16)
...
s_correct = load_s("correct.wav")
s_wrong = load_s("wrong.wav")
